...
// Karunena-Loeva.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKarunenaLoevaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKarunenaLoevaApp

CKarunenaLoevaApp::CKarunenaLoevaApp()
{
...
// Единственный объект CKarunenaLoevaApp

CKarunenaLoevaApp theApp;


// Инициализация CKarunenaLoevaApp

BOOL CKarunenaLoevaApp::InitInstance()
{
